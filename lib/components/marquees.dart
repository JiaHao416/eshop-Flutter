...
class Marquees extends StatefulWidget {
  ...
  /// ## Sample code
  ///
  /// This [Marquees] starts scrolling one second after being displayed.
  ///
  /// ```dart
  /// Marquee(
  ...
  /// The fraction of the [Marquees] that will be faded on the left or top.
  ...
  /// The fraction of the [Marquees] that will be faded on the right or down.
  /// By default, there won't be any fading.
  ///
  /// ## Sample code
  ///
  ...
  /// This function will be called if [numberOfRounds] is set and the [Marquees]
  ...
  @override
  State<StatefulWidget> createState() => _MarqueesState();
}
...
class _MarqueesState extends State<Marquees>
  ...
  void didUpdateWidget(Widget oldWidget) {
    super.didUpdateWidget(oldWidget as Marquees);
  }
